...
const TOKEN = "BBUS-hzkWIyjviXJhhnOJQM2Q0BRAAtCPzn";
        ...
        const fetchData = async () => {
            try {
                ...
                if (result.results.length > 0) {
                    ...
                    console.warn("No hay datos en Ubidots.");
                }
            } catch (error) {
    ...
    return (
        <div className="p-4">
            ...
            {data.length > 0 ? (
                ...
                <p className="text-red-500">No hay datos disponibles. Verifica la conexión con Ubidots.</p>
            )}
        </div>
    );
};
